...
class Customer extends Component {
    ...
    refreshList = () => {
    axios
        .get("https://maria-demo-backend.herokuapp.com/api/customer/")
    ...
    if (item.id) {
        axios
        .put(`https://maria-demo-backend.herokuapp.com/api/customer/${item.id}/`, item)
        .then(res => this.refreshList());
        return;
    }
    axios
        .post("https://maria-demo-backend.herokuapp.com/api/customer/", item)
        .then(res => this.refreshList());
    };
    handleDelete = item => {
    axios
        .delete(`https://maria-demo-backend.herokuapp.com/api/customer/${item.id}`)
        .then(res => this.refreshList());
    };
    createItem = () => {
