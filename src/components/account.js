...
class Account extends Component {
    ...
    refreshList = () => {
    axios
        .get("https://maria-staging-backend.herokuapp.com/api/account/")
    ...
    if (item.id) {
        axios
        .put(`https://maria-staging-backend.herokuapp.com/api/account/${item.id}/`, item)
        .then(res => this.refreshList());
        return;
    }
    axios
        .post("https://maria-staging-backend.herokuapp.com/api/account/", item)
        .then(res => this.refreshList());
    };
    handleDelete = item => {
    axios
        .delete(`https://maria-staging-backend.herokuapp.com/api/account/${item.id}`)
        .then(res => this.refreshList());
    };
    createItem = () => {
